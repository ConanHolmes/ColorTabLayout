...
public class ColorTrackView extends View {
    ...
    public ColorTrackView(Context context, AttributeSet attrs) {
        ...
        mText = ta.getString(R.styleable.ColorClipView_text);
        mTextSize = ta.getDimensionPixelSize(
                R.styleable.ColorClipView_text_size, mTextSize);
        mTextOriginColor = ta.getColor(
                R.styleable.ColorClipView_text_unselected_color, mTextOriginColor);
        mTextChangeColor = ta.getColor(
                R.styleable.ColorClipView_text_selected_color, mTextChangeColor);
        mProgress = ta.getFloat(R.styleable.ColorClipView_progress, 0);

        mDirection = ta
                .getInt(R.styleable.ColorClipView_direction, mDirection);
